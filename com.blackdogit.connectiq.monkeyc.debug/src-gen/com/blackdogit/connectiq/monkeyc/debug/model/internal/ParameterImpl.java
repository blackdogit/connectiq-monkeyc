 ...
 * <ul>
 *   <li>{@link com.blackdogit.connectiq.monkeyc.debug.model.internal.ParameterImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ParameterImpl extends MinimalEObjectImpl.Container implements IParameter {
	...
	protected EClass eStaticClass() {
		return IDebugInfoPackage.Literals.PARAMETER;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, IDebugInfoPackage.PARAMETER__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case IDebugInfoPackage.PARAMETER__NAME:
				return getName();
		}
